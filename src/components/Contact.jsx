...
const Contact = () => {
  ...
  const [location, setLocation] = useState({  lat: 13.0827, lng: 80.2707  }); // default Delhi
  ...
  return (
    <section className="text-gray-600 body-font relative pt-16">
      <div className="container px-5 py-12 mx-auto flex flex-col lg:flex-row gap-8">
        
        {/* Left Side - Map */}
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden p-4 flex items-end justify-start relative h-96">
          <iframe
            width="100%"
            height="100%"
        ...
        <div className="lg:w-2/4 md:w-1/2 w-full bg-white flex flex-col items-center justify-center mx-auto p-6 rounded-xl shadow-lg">
          <h2 className="text-gray-900 text-2xl mb-4 font-semibold text-center title-font">
            Contact
          </h2>
